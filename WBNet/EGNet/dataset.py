...
class ImageDataTrain(data.Dataset):
    def __init__(self):
        ...
        self.sal_root = '/home/avicii/dataset/DUTS/DUTS-TR' # 这个是为训练集的地址，代码会提供
        self.sal_source = '/home/avicii/dataset/DUTS/DUTS-TR/train_pair_edge.lst' # .lst文件,记录图片的信息
...
class ImageDataTest(data.Dataset):###
    def __init__(self, test_mode=1, sal_mode='e',mdir='pretty',msk_path='/home/camus/Desktop/WebSegmentSystem/InOutput'):   ###
        if test_mode == 0:
            ...
            self.image_root = '/media/camus/Ubuntu/1_learing/dataset/SOD/RGBD/STERE/depth/' # 测试集地址，可以去下载相应的数据集，放在指定目录
            self.image_source = '/media/camus/Ubuntu/1_learing/dataset/SOD/RGBD/STERE/test.lst' # 对应数据集的lst文件，这是必要的，代码通过这个文件load图片进去，
            
            
        elif test_mode == 1:
            if sal_mode == 'e':
                self.image_root = '/home/avicii/dataset/saliency_test/ECSSD/Imgs/'
                self.image_source = '/home/avicii/dataset/saliency_test/ECSSD/test.lst'
                self.test_fold = '/media/avicii/Ubuntu/disk/Result/saliency/ECSSD/'
            elif sal_mode == 'p':
                self.image_root = '/home/avicii/dataset/saliency_test/PASCALS/Imgs/'
                self.image_source = '/home/avicii/dataset/saliency_test/PASCALS/test.lst'
                self.test_fold = '/media/ubuntu/disk/Result/saliency/PASCALS/'
            elif sal_mode == 'd':
                self.image_root = '/home/avicii/dataset/saliency_test/DUTOMRON/Imgs/'
                self.image_source = '/home/avicii/dataset/saliency_test/DUTOMRON/test.lst' # 绝对路径加文件名就可以啦
                self.test_fold = '/home/avicii/SalientObject/Result/saliency/DUTOMRON/'
            elif sal_mode == 'h':
                self.image_root = '/home/avicii/dataset/saliency_test/HKU-IS/Imgs/'
                self.image_source = '/home/avicii/dataset/saliency_test/HKU-IS/test.lst'
                self.test_fold = '/media/avicii/Ubuntu/disk/Result/saliency/HKU-IS/'
            elif sal_mode == 's':
                self.image_root = '/home/avicii/dataset/saliency_test/SOD/Imgs/'
                self.image_source = '/home/avicii/dataset/saliency_test/SOD/test.lst'
                self.test_fold = '/media/ubuntu/disk/Result/saliency/SOD/'
            elif sal_mode == 'm':
                self.image_root = '/home/avicii/dataset/saliency_test/MSRA/Imgs/'
                self.image_source = '/home/avicii/dataset/saliency_test/MSRA/test.lst'
            elif sal_mode == 'o':
                self.image_root = '/home/avicii/dataset/saliency_test/SOC/TestSet/Imgs/'
                self.image_source = '/home/avicii/dataset/saliency_test/SOC/TestSet/test.lst'
                self.test_fold = '/media/ubuntu/disk/Result/saliency/SOC/'
            elif sal_mode == 't':
                #self.image_root = '/home/camus/Desktop/WBNet/InOutput/'+mdir
                self.image_root = msk_path + '/' +mdir
                #self.image_source = '/home/camus/Desktop/WBNet/InOutput/'+mdir+'.lst'
                self.image_source = msk_path +'/'+ mdir + '.lst'
                #self.test_fold = '/home/camus/Desktop/WBNet/InOutput/'+mdir
                self.test_fold = msk_path + '/' + mdir
        elif test_mode == 2:

            self.image_root = '/home/avicii/dataset/SK-LARGE/images/test/'
            self.image_source = '/home/avicii/dataset/SK-LARGE/test.lst'
...
def get_loader(batch_size, mode='train', num_thread=1, test_mode=0, sal_mode='e',mdir='pretty',msk_path='/home/camus/Desktop/WBSystem/InOutput'):####
    shuffle = False
    if mode == 'train':
        shuffle = True
        dataset = ImageDataTrain()
    else:
        dataset = ImageDataTest(test_mode=test_mode, sal_mode=sal_mode,mdir=mdir,msk_path=msk_path)###
