...
from EGNet.model import build_model, weights_init
...
class Solver(object):
    def __init__(self, train_loader, test_loader, config, save_fold):
    ...
    def test(self, test_mode=0):
        ...
        for i, data_batch in enumerate(self.test_loader):
            ...
            with torch.no_grad():
                ...
                cv2.imwrite(os.path.join(self.config.test_fold,name_t, name[:-4] + '.jpg'), multi_fuse)
